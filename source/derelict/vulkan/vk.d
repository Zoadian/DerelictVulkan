...
alias PFN_vkVoidFunction = void function(void);
...
alias PFN_vkCreateDevice = VkResult (VkPhysicalDevice physicalDevice, const VkDeviceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDevice* pDevice);
...
alias PFN_vkAllocateMemory = VkResult functionVkDevice device, const VkMemoryAllocateInfo* pAllocateInfo, const VkAllocationCallbacks* pAllocator, VkDeviceMemory* pMemory);
...
alias PFN_vkCmdSetBlendConstants = void function(VkCommandBuffer commandBuffer, const float blendConstants[4]);
...
extern(C) VkResult vkEnumeratePhysicalDevices(
    VkInstance                                  instance,
...
extern(C) PFN_vkVoidFunction vkGetInstanceProcAddr(
    VkInstance                                  instance,
    const char*                                 pName);

extern(C) PFN_vkVoidFunction vkGetDeviceProcAddr(
    VkDevice                                    device,
    const char*                                 pName);
...
extern(C) VkResult vkEnumerateDeviceLayerProperties(
    VkPhysicalDevice                            physicalDevice,
    uint*                                   pPropertyCount,
    VkLayerProperties*                          pProperties);
...
extern(C) VkResult vkQueueWaitIdle(
    VkQueue                                     queue);

extern(C) VkResult vkDeviceWaitIdle(
    VkDevice                                    device);

extern(C) VkResult vkAllocateMemory(
    VkDevice                                    device,
...
extern(C) VkResult vkFlushMappedMemoryRanges(
    VkDevice                                    device,
    uint                                    memoryRangeCount,
    const VkMappedMemoryRange*                  pMemoryRanges);

extern(C) VkResult vkInvalidateMappedMemoryRanges(
    VkDevice                                    device,
    uint                                    memoryRangeCount,
    const VkMappedMemoryRange*                  pMemoryRanges);
...
extern(C) VkResult vkBindBufferMemory(
    VkDevice                                    device,
    VkBuffer                                    buffer,
    VkDeviceMemory                              memory,
    VkDeviceSize                                memoryOffset);

extern(C) VkResult vkBindImageMemory(
    VkDevice                                    device,
    VkImage                                     image,
    VkDeviceMemory                              memory,
    VkDeviceSize                                memoryOffset);
...
extern(C) VkResult vkQueueBindSparse(
    VkQueue                                     queue,
    uint                                    bindInfoCount,
    const VkBindSparseInfo*                     pBindInfo,
    VkFence                                     fence);

extern(C) VkResult vkCreateFence(
    VkDevice                                    device,
...
extern(C) VkResult vkResetFences(
    VkDevice                                    device,
    uint                                    fenceCount,
    const VkFence*                              pFences);

extern(C) VkResult vkGetFenceStatus(
    VkDevice                                    device,
    VkFence                                     fence);

extern(C) VkResult vkWaitForFences(
    VkDevice                                    device,
    uint                                    fenceCount,
    const VkFence*                              pFences,
    VkBool32                                    waitAll,
...
extern(C) VkResult vkCreateSemaphore(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateEvent(
    VkDevice                                    device,
...
extern(C) VkResult vkGetEventStatus(
    VkDevice                                    device,
    VkEvent                                     event);

extern(C) VkResult vkSetEvent(
    VkDevice                                    device,
    VkEvent                                     event);

extern(C) VkResult vkResetEvent(
    VkDevice                                    device,
    VkEvent                                     event);

extern(C) VkResult vkCreateQueryPool(
    VkDevice                                    device,
...
extern(C) VkResult vkGetQueryPoolResults(
    VkDevice                                    device,
    VkQueryPool                                 queryPool,
    uint                                    firstQuery,
    uint                                    queryCount,
...
extern(C) VkResult vkCreateBuffer(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateBufferView(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateImage(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateImageView(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateShaderModule(
    VkDevice                                    device,
...
extern(C) VkResult vkCreatePipelineCache(
    VkDevice                                    device,
...
extern(C) VkResult vkGetPipelineCacheData(
    VkDevice                                    device,
    VkPipelineCache                             pipelineCache,
    size_t*                                     pDataSize,
    void*                                       pData);

extern(C) VkResult vkMergePipelineCaches(
    VkDevice                                    device,
...
extern(C) VkResult vkCreatePipelineLayout(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateSampler(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateDescriptorSetLayout(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateDescriptorPool(
    VkDevice                                    device,
...
extern(C) VkResult vkResetDescriptorPool(
    VkDevice                                    device,
    VkDescriptorPool                            descriptorPool,
    VkDescriptorPoolResetFlags                  flags);

extern(C) VkResult vkAllocateDescriptorSets(
    VkDevice                                    device,
    const VkDescriptorSetAllocateInfo*          pAllocateInfo,
    VkDescriptorSet*                            pDescriptorSets);

extern(C) VkResult vkFreeDescriptorSets(
    VkDevice                                    device,
    VkDescriptorPool                            descriptorPool,
    uint                                    descriptorSetCount,
...
extern(C) VkResult vkCreateFramebuffer(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateRenderPass(
    VkDevice                                    device,
...
extern(C) VkResult vkCreateCommandPool(
    VkDevice                                    device,
...
extern(C) VkResult vkResetCommandPool(
    VkDevice                                    device,
    VkCommandPool                               commandPool,
    VkCommandPoolResetFlags                     flags);

extern(C) VkResult vkAllocateCommandBuffers(
    VkDevice                                    device,
...
extern(C) VkResult vkBeginCommandBuffer(
    VkCommandBuffer                             commandBuffer,
    const VkCommandBufferBeginInfo*             pBeginInfo);

extern(C) VkResult vkEndCommandBuffer(
    VkCommandBuffer                             commandBuffer);

extern(C) VkResult vkResetCommandBuffer(
    VkCommandBuffer                             commandBuffer,
...
extern(C) VkResult vkGetPhysicalDeviceSurfacePresentModesKHR(
    VkPhysicalDevice                            physicalDevice,
    VkSurfaceKHR                                surface,
...
extern(C) VkResult vkGetSwapchainImagesKHR(
    VkDevice                                    device,
    VkSwapchainKHR                              swapchain,
    uint*                                   pSwapchainImageCount,
    VkImage*                                    pSwapchainImages);

extern(C) VkResult vkAcquireNextImageKHR(
    VkDevice                                    device,
    VkSwapchainKHR                              swapchain,
    ulong                                    timeout,
    VkSemaphore                                 semaphore,
...
extern(C) VkResult vkQueuePresentKHR(
    VkQueue                                     queue,
...
extern(C) VkResult vkGetPhysicalDeviceDisplayPlanePropertiesKHR(
    VkPhysicalDevice                            physicalDevice,
    uint*                                   pPropertyCount,
    VkDisplayPlanePropertiesKHR*                pProperties);

extern(C) VkResult vkGetDisplayPlaneSupportedDisplaysKHR(
    VkPhysicalDevice                            physicalDevice,
    uint                                    planeIndex,
    uint*                                   pDisplayCount,
    VkDisplayKHR*                               pDisplays);

extern(C) VkResult vkGetDisplayModePropertiesKHR(
    VkPhysicalDevice                            physicalDevice,
    VkDisplayKHR                                display,
    uint*                                   pPropertyCount,
    VkDisplayModePropertiesKHR*                 pProperties);

extern(C) VkResult vkCreateDisplayModeKHR(
    VkPhysicalDevice                            physicalDevice,
    VkDisplayKHR                                display,
...
extern(C) VkResult vkGetDisplayPlaneCapabilitiesKHR(
    VkPhysicalDevice                            physicalDevice,
    VkDisplayModeKHR                            mode,
    uint                                    planeIndex,
    VkDisplayPlaneCapabilitiesKHR*              pCapabilities);

extern(C) VkResult vkCreateDisplayPlaneSurfaceKHR(
    VkInstance                                  instance,
...
extern(C) VkBool32 vkGetPhysicalDeviceXlibPresentationSupportKHR(
    VkPhysicalDevice                            physicalDevice,
    uint                                    queueFamilyIndex,
    Display*                                    dpy,
    VisualID                                    visualID);
...
extern(C) VkBool32 vkGetPhysicalDeviceXcbPresentationSupportKHR(
    VkPhysicalDevice                            physicalDevice,
    uint                                    queueFamilyIndex,
    xcb_connection_t*                           connection,
...
alias PFN_vkGetPhysicalDeviceWaylandPresentationSupportKHR = VkBool32 function(VkPhysicalDevice physicalDevice, uint queueFamilyIndex, struct wl_display* display);
...
extern(C) VkBool32 vkGetPhysicalDeviceMirPresentationSupportKHR(
    VkPhysicalDevice                            physicalDevice,
    uint                                    queueFamilyIndex,
    MirConnection*                              connection);
}
...
extern(C) VkBool32 vkGetPhysicalDeviceWin32PresentationSupportKHR(
    VkPhysicalDevice                            physicalDevice,
    uint                                    queueFamilyIndex);
}
}
...
extern(C) void vkDestroyDebugReportCallbackEXT(
    VkInstance                                  instance,
    VkDebugReportCallbackEXT                    callback,
    const VkAllocationCallbacks*                pAllocator);

extern(C) void vkDebugReportMessageEXT(
    VkInstance                                  instance,
    VkDebugReportFlagsEXT                       flags,
    VkDebugReportObjectTypeEXT                  objectType,
    ulong                                    object,
